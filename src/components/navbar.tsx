...
const NavbarLogo = () => {
  return (
    <a href="" className="flex ml-2 md:mr-24">
      <Image width={28} height={28} src={appConfig.logoUrl} className="h-8 mr-3" alt="FlowBite Logo" />
      <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">{appConfig.appName}</span>
    </a>
  )
}
